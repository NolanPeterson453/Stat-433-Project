...
As can be seen in the above interval for difference of means 0 is at the far end of the interval but not excluded from it. Indicating that even at the $95\%$ confidence level the possibility that the difference in population means is 0 should not be excluded. Agian the null hypothesis is not rejected.
